...
> **Status: Beta.** RICE v2 is under active development. For production use, see [RICE v1](https://github.com/mosking128/PicoScript) (stable, bare-metal).
...
### Planned
- Motion control task (trajectory planning, step pulse generation)
- Monitoring task (temperature, limit switches, anomaly detection)
- Application-level APIs exposed to PicoC scripts (e.g. `motor_move_to()`)
...
- [RICE v1](https://github.com/mosking128/PicoScript) — Stable bare-metal release, recommended for production use
